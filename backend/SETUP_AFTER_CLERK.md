...
CLERK_SECRET_KEY=-----BEGIN PUBLIC KEY-----\\n...\\n-----END PUBLIC KEY-----
...
The backend pins Pydantic 2.11.2 because the current `clerk-backend-api==6.0.1` requires Pydantic >=2.11.2. Do not keep Pydantic 2.10.6 in this environment. If you created the virtual environment from an older ZIP, recreate it or run `python -m pip install --upgrade -r requirements.txt`.
